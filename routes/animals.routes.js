...
const {renderAnimales,  renderAddAnimal, addAnimal, busquedaAnimal, renderAnimal, solicitudAnimal,editAnimal,renderEditAnimal} = require('../controllers/animals.controller')
